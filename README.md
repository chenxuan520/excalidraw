...
9. 新增思维导图模板工具箱，支持思维导图 / 树状图 / 时间线模板，插入后仍可继续编辑，并支持快速添加子节点 / 同级节点
10. release 中提供可直接使用的前端静态构建产物
11. 新增 Markdown -> 思维导图导入，支持标题层级 / 嵌套列表转换，并可配置样式、字体、最大层级
12. 增强 Mermaid -> Excalidraw 导入，支持 Flowchart / Sequence Diagram / Class Diagram、字体设置，并暂时隐藏文字至图表入口
